...
export const BellIcon: React.FC<{ className?: string }> = ({ className = "w-6 h-6" }) => (
    <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="currentColor" className={className}>
      <path fillRule="evenodd" d="M5.25 9a6.75 6.75 0 0113.5 0v.75c0 2.123.8 4.057 2.118 5.52a.75.75 0 01-.297 1.206c-1.544.57-3.16.99-4.831 1.243a3.75 3.75 0 11-7.48 0c-1.67-.253-3.287-.673-4.83-1.244a.75.75 0 01-.298-1.205A8.217 8.217 0 004.5 9.75V9zm4.502 8.9a2.25 2.25 0 104.496 0L9.752 17.9z" clipRule="evenodd" />
    </svg>
);
  
export const BellSlashIcon: React.FC<{ className?: string }> = ({ className = "w-6 h-6" }) => (
    <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="currentColor" className={className}>
        <path fillRule="evenodd" d="M10.04 4.5A5.25 5.25 0 0115.25 9v.75c0 .313.03.62.086.924a.75.75 0 01-1.459.395A2.992 2.992 0 0013.5 9.75V9a3.75 3.75 0 00-7.5 0v.162c0 .393-.112.766-.316 1.08a.75.75 0 01-1.28-.76 4.49 4.49 0 01.316-1.08V9a5.25 5.25 0 014.79-5.207c.186-.016.372-.026.56-.026zM9.752 17.9a2.25 2.25 0 104.496 0L9.752 17.9z" clipRule="evenodd" />
        <path d="M3.523 5.432a.75.75 0 011.055-.09l15.5 12.5a.75.75 0 01-1.144.974l-1.926-1.55a.75.75 0 01.19-1.285 8.217 8.217 0 002.118-5.52V9a6.75 6.75 0 00-10.322-5.852.75.75 0 01-.6-1.345A8.25 8.25 0 0119.5 9v.75c0 2.123-.8 4.057-2.118 5.52a.75.75 0 01-.297 1.206c-1.544.57-3.16.99-4.831 1.243a3.75 3.75 0 01-4.226 0 .75.75 0 01-.225-.015 4.502 4.502 0 01-3.14-2.26c-1.021-.498-1.932-1.12-2.737-1.823a.75.75 0 01-.298-1.205 8.217 8.217 0 011.618-5.52V9a6.75 6.75 0 01.75-3.415l-2.62-2.112a.75.75 0 01-.09-1.055z" />
    </svg>
);
...
export const ClipboardIcon: React.FC<{ className?: string }> = ({ className = "w-6 h-6" }) => (
    <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" className={className}>
        <path strokeLinecap="round" strokeLinejoin="round" d="M15.666 3.888A2.25 2.25 0 0 0 13.5 2.25h-3c-1.03 0-1.9.693-2.166 1.638m7.332 0c.055.194.084.4.084.612v3.042m-7.332 0c-.055.194-.084.4-.084.612v3.042m0 0a2.25 2.25 0 0 0 2.25 2.25h3a2.25 2.25 0 0 0 2.25-2.25V6.75m-7.5 0V6.75m0 0H4.5m11.25 0a2.25 2.25 0 0 1 2.25 2.25V19.5a2.25 2.25 0 0 1-2.25 2.25h-9a2.25 2.25 0 0 1-2.25-2.25V9a2.25 2.25 0 0 1 2.25-2.25h9.75Z" />
    </svg>
);
